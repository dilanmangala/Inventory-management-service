...
@Repository
@Slf4j
public class ApprovalPurchaseOrderListRepository {
    ...
    public ApprovalPurchaseOrderListRepository(EntityManager entityManager,
    ...
    public Page<PurchaseOrder> approverList(PurchaseOrderSearch purchaseOrderSearch, PurchaseOrderPage purchaseOrderPage) {
        ...
        Predicate predicate = getPredicatesForPurchaseOrders(purchaseOrderSearch, purchaseOrderRoot, supplierJoin);
        criteriaQuery.where(predicate);

        setOrder(purchaseOrderPage, criteriaQuery, purchaseOrderRoot);

        long count = getPurchaseOrderCount(purchaseOrderSearch);
    ...
    private Predicate getPredicatesForPurchaseOrders(PurchaseOrderSearch purchaseOrderSearch,
        ...
        predicates.add(criteriaBuilder.equal(
                criteriaBuilder.upper(purchaseOrderRoot.get("statusCode")),
    ...
    public long getPurchaseOrderCount(PurchaseOrderSearch purchaseOrderSearch) {
        ...
        Predicate predicate = getPredicatesForPurchaseOrders(purchaseOrderSearch, countRoot, supplierJoin);
