...
/**
 * Fetch all POs excluding DRAFT status AND not equals to current logged in user
 */

@Repository
@Slf4j
public class PurchaseOrderListRepository {
    ...
    @Autowired
    public PurchaseOrderListRepository(EntityManager entityManager,
    ...
    public Page<PurchaseOrder> listOthers(PurchaseOrderSearch purchaseOrderSearch, PurchaseOrderPage purchaseOrderPage, String userId) {
    ...
    private Predicate getPredicatesForPurchaseOrders(PurchaseOrderSearch purchaseOrderSearch,
                                                     ...
                                                     Join<PurchaseOrder, Supplier> supplierJoin, String userId) {
        ...
        // List Others AND status code not equals DRAFT
        predicates.add(criteriaBuilder.notEqual(purchaseOrderRoot.get("userId"), userId));
